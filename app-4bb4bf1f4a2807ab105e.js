/*! For license information please see app-4bb4bf1f4a2807ab105e.js.LICENSE.txt */
  ...
  [524],
  {
    ...
    6877: function (e, t, n) {
      t.components = {
        ...
        'component---src-pages-404-js': () =>
          Promise.all([n.e(559), n.e(125)]).then(n.bind(n, 3331)),
        'component---src-pages-archive-js': () =>
          Promise.all([n.e(559), n.e(231)]).then(n.bind(n, 3229)),
        'component---src-pages-index-js': () =>
          Promise.all([n.e(559), n.e(293)]).then(n.bind(n, 9639)),
        'component---src-pages-pensieve-index-js': () =>
          Promise.all([n.e(559), n.e(29)]).then(n.bind(n, 1523)),
        'component---src-pages-pensieve-tags-js': () =>
          Promise.all([n.e(559), n.e(846)]).then(n.bind(n, 5058)),
        'component---src-templates-post-js': () =>
          Promise.all([n.e(559), n.e(480)]).then(n.bind(n, 7560)),
        'component---src-templates-tag-js': () =>
          Promise.all([n.e(559), n.e(502)]).then(n.bind(n, 1804)),
      };
    },
    9377: function (e, t, n) {
      e.exports = [
        ...
        },
        {
          ...
          options: {
            ...
            include_favicon: !0,
            cacheDigest: '87ba5ba81c4cb3872d962112a254f24d',
          },
        },
    ...
    4794: function (e, t, n) {
      ...
      n.r(t),
        n.d(t, {
          ...
          collectedScriptsByPage: function () {
            return E.collectedScriptsByPage;
          },
          graphql: function () {
            return _;
          },
      ...
      const y = e => {
          ...
          const r = [
            h.createElement('slice-start', { id: `${t}-1` }),
            h.createElement('slice-end', { id: `${t}-1` }),
          ];
          return (
            n &&
              (r.push(n),
              r.push(
                h.createElement('slice-start', { id: `${t}-2` }),
                h.createElement('slice-end', { id: `${t}-2` }),
              )),
            r
          );
        },
        v = e => {
          ...
          const a = (0, h.useContext)(g.Jr),
            i = (0, h.useContext)(g.hr),
            s = a[t];
          if (!s) {
            if (n) return null;
            throw new Error(`Slice "${s}" for "${t}" slot not found`);
          }
          const c = ((e, t) => (Object.keys(t).length ? `${e}-${(0, m.U)(t)}` : e))(s, o);
          let l = i[c];
          return (
            l
              ? r && (l.hasChildren = !0)
              : (i[c] = l = { props: o, sliceName: s, hasChildren: !!r }),
      ...
      function w(e) {
        {
          ...
          const n = (0, h.useContext)(g.j$),
            r = C(e);
          if (Object.keys(r).length)
            throw new S('browser' === n.renderEnvironment, t.sliceName, r, e.__renderedByLocation);
          if ('server' === n.renderEnvironment) return h.createElement(v, t);
          if ('browser' === n.renderEnvironment) return h.createElement(b, t);
          if ('engines' === n.renderEnvironment || 'dev-ssr' === n.renderEnvironment)
            return h.createElement(b, t);
      ...
      let S = (function (e) {
        function t(n, r, o, a) {
          ...
          if (n) {
            const e =
              h.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactDebugCurrentFrame.getCurrentStack()
                .trim()
                .split('\n')
                .slice(1);
            (e[0] = e[0].trim()),
              (l = '\n' + e.join('\n')),
              (u = `Slice "${r}" was passed props that are not serializable (${s}).`);
          } else {
            u = `${c}: Slice "${r}" was passed props that are not serializable (${s}).`;
            l = `${u}\n${new Error().stack.trim().split('\n').slice(2).join('\n')}`;
          }
          return (
            ((i = e.call(this, u) || this).name = c),
            l ? (i.stack = l) : Error.captureStackTrace(i, t),
          ...
          (t.loadPage = function (e) {
            ...
            const r = Promise.all(n).then(e => {
              ...
              const { componentChunkName: c, staticQueryHashes: u = [], slicesMap: d = {} } = s,
                f = {},
                h = Array.from(new Set(Object.values(d))),
                m = e => {
              ...
              return Promise.all(h.map(e => this.loadSliceDataJson(e))).then(e => {
                ...
                const b = Promise.all(v).then(e => {
                    ...
                    for (const n of t)
                      (!n || n instanceof Error) && ((f.status = p.Error), (f.error = n));
                    let l;
                    if (
                      ((!c || c instanceof Error) && ((f.status = p.Error), (f.error = c)),
                      f.status !== p.Error)
                    ) {
                      if (
                        ((f.status = p.Success),
                        ...
                        (l = g(s, null, o)), (l.partialHydration = i.payload);
                        ...
                        return y((0, a.createFromReadableStream)(e)).then(
                          e => ((l.partialHydration = e), l),
                        );
                      }
                      l = g(s, c, o);
                    }
                  ...
                  .then(e => {
                    ...
                    return (
                      r &&
                        ...
                        (f.payload = n),
                        l.A.emit('onPostLoadPageResources', { page: n, pageResources: n })),
                      this.pageDb.set(t, f),
        ...
        S = (function (e) {
          function t(t, n, r) {
            ...
            return (
              ...
              r &&
                o.pageDataDb.set((0, u.Hh)(r.path), {
                  pagePath: r.path,
                  payload: r,
                  status: 'success',
                }),
      ...
      function m(e, t) {
        ...
        for (const l of e.childNodes) {
          ...
          const e = l.nodeName.toLowerCase(),
            u =
              null === (o = l.attributes) || void 0 === o || null === (a = o.id) || void 0 === a
                ? void 0
                : a.value;
          if (v(l)) {
            if (y(e))
    ...
    6498: function (e, t, n) {
      ...
      const y = (e, t) => {
        ...
        b = function (e, t) {
          ...
          const { pathname: n, search: r, hash: a } = (0, h.Rr)(e),
            s = (0, p.X)(n);
      ...
      let E = (function (e) {
        ...
        return (
          ...
          (n.shouldComponentUpdate = function (e) {
            return !!C(this.props.location, e.location) && (y(e.location, this.props.location), !0);
          }),
          (n.componentDidUpdate = function (e) {
            C(e.location, this.props.location) && v(this.props.location, e.location);
          }),
          (n.render = function () {
      ...
      var R = (function (e) {
          function t(t) {
            ...
            return (
              (n.state = {
                location: { ...r },
                pageResources:
                  o || u.Ay.loadPageSync(r.pathname + r.search, { withErrorDetails: !0 }),
              }),
              n
            );
          }
          (0, r.A)(t, e),
            (t.getDerivedStateFromProps = function (e, t) {
              ...
              if (t.location.href !== n.href) {
                return {
                  pageResources: u.Ay.loadPageSync(n.pathname + n.search, { withErrorDetails: !0 }),
                  location: { ...n },
                };
              }
              return { location: { ...n } };
        ...
        x = n(8797),
        A = n(9732);
      const O = new u.N5(_, [], window.pageData);
      (0, u.iC)(O), O.setApiRunner(o.N);
      const { render: T, hydrate: j } = (0, A.n)();
      (window.asyncRequires = _),
        (window.___emitter = d.A),
        (window.___loader = u.Zf),
      ...
      (0, o.v)('onClientEntry').then(() => {
        ...
        h &&
          ...
          !(
            O.findMatchPath((0, x.A)(m.pathname, '')) ||
            h.match(/^\/(404|500)(\/?|.html)$/) ||
            h.match(/^\/offline-plugin-app-shell-fallback\/?$/)
          ) &&
          (0, i.navigate)('' + h + (h.includes('?') ? '' : m.search) + m.hash, { replace: !0 });
        const g = () => {
          try {
        ...
        u.Zf.loadPage(m.pathname + m.search).then(e => {
          ...
          if ((n && n.removeItem(N), !e || e.status === u.Wi.Error)) {
      ...
      function b(e, t) {
        if ('' !== t) {
          ...
          switch (((i = t.substring(i + 1)), o)) {
            case 'J':
              (o = (t = e._chunks).get(s))
                ? 0 === o._status && ((e = o._value), (o._status = 1), (o._value = i), h(e))
                : t.set(s, new u(1, i, e));
              break;
            case 'M':
              ...
              o
                ? 0 === o._status && ((e = o._value), (o._status = 2), (o._value = i), h(e))
                : t.set(s, new u(2, i, e));
              break;
            case 'P':
              e._chunks.set(
            ...
            case 'E':
              (t = JSON.parse(i)),
                ...
                (i = (t = e._chunks).get(s)) ? m(i, o) : t.set(s, new u(4, o, e));
              break;
            default:
              throw Error(
                ...
                switch (n[0]) {
                  case '$':
                    return '$' === n
                      ...
                      : '$' === n[1] || '@' === n[1]
                      ? n.substring(1)
                      : p((e = y(e, parseInt(n.substring(1), 16))));
                  case '@':
                    return (
                      (e = y(e, parseInt(n.substring(1), 16))),
    ...
    2833: function (e) {
      e.exports = function (e, t, n, r) {
        ...
        for (var s = Object.prototype.hasOwnProperty.bind(t), c = 0; c < a.length; c++) {
          ...
          var u = e[l],
            p = t[l];
          if (!1 === (o = n ? n.call(r, u, p, l) : void 0) || (void 0 === o && u !== p)) return !1;
        }
        return !0;
      };
    },
    4612: function (e, t, n) {
      ...
      var s = function (e) {
          function t(e, r, c, l, d) {
            for (
              ...
              if (
                ...
                L === F &&
                  0 !== E + _ + k + C &&
                  (0 !== E && (h = 47 === E ? 10 : 47), (_ = k = C = 0), W++, F++),
                0 === E + _ + k + C)
              ) {
                if (L === F && (0 < $ && (U = U.replace(p, '')), 0 < U.trim().length)) {
                  switch (h) {
                    case 32:
                    case 9:
                    case 59:
                ...
                switch (h) {
                  case 123:
                    for (f = (U = U.trim()).charCodeAt(0), m = 1, H = ++L; L < W; ) {
                              ...
                              e: {
                                for (I = L + 1; I < F; ++I)
                                  switch (c.charCodeAt(I)) {
                                    case 47:
                                      if (42 === h && 42 === c.charCodeAt(I - 1) && L + 2 !== I) {
                                        L = I + 1;
                                        break e;
                                      }
                                      break;
                    ...
                    if (
                      ...
                      switch ((0 < $ && (U = U.replace(p, '')), (h = U.charCodeAt(1)))) {
                        case 100:
                        case 109:
                        case 115:
                        case 45:
                      ...
                      if (
                        ((H = (m = t(r, $, m, h, d + 1)).length),
                        0 < N &&
                          ((w = s(3, m, ($ = n(T, U, M)), r, x, R, H, h, d, l)),
                          (U = $.join('')),
                    ...
                    } else m = t(r, n(r, U, M), m, l, d + 1);
                    (B += m), (m = M = $ = I = f = 0), (U = ''), (h = c.charCodeAt(++L));
                    break;
                  case 125:
                  case 59:
                    if (1 < (H = (U = (0 < $ ? U.replace(p, '') : U).trim()).length))
                      switch (
                        (0 === I &&
                          ((f = U.charCodeAt(0)), 45 === f || (96 < f && 123 > f)) &&
                          (H = (U = U.replace(' ', ':')).length),
                        0 < N &&
                          void 0 !== (w = s(1, U, r, e, x, R, q.length, l, d, l)) &&
                          0 === (H = (U = w.trim()).length) &&
                          (U = '\0\0'),
                        (f = U.charCodeAt(0)),
                        (h = U.charCodeAt(1)),
                        ...
                        default:
                          58 !== U.charCodeAt(H - 1) && (q += o(U, f, h, U.charCodeAt(2)));
                      }
                    (M = $ = I = f = 0), (U = ''), (h = c.charCodeAt(++L));
                }
              }
              switch (h) {
                case 13:
                case 10:
                  47 === E
                    ? (E = 0)
                    : 0 === 1 + f && 107 !== l && 0 < U.length && (($ = 1), (U += '\0')),
                    0 < N * D && s(0, U, r, e, x, R, q.length, l, d, l),
                    (R = 1),
                    x++;
                  break;
                case 59:
                        ...
                        switch (E) {
                          ...
                          case 42:
                            47 === h &&
                              42 === P &&
                              H + 2 !== L &&
                              (33 === c.charCodeAt(H + 2) && (q += c.substring(H, L + 1)),
                              (g = ''),
                              (E = 0));
                        }
                  }
            ...
            if (0 < (H = q.length)) {
              if (
                (($ = r),
                0 < N && void 0 !== (w = s(2, q, $, e, x, R, H, l, d, l)) && 0 === (q = w).length)
              )
                return z + q + B;
              if (((q = $.join(',') + '{' + q + '}'), 0 != O * A)) {
                switch ((2 !== O || a(q, 2) || (A = 0), A)) {
                  case 111:
          ...
          function a(e, t) {
            ...
            return (
              (n = e.substring(n + 1, e.length - 1)), I(2 !== t ? r : r.replace(k, '$1'), n, t)
            );
          }
          function i(e, t) {
          ...
          function s(e, t, n, r, o, a, i, s, c, u) {
            for (var p, d = 0, f = t; d < N; ++d)
              switch ((p = j[d].call(l, e, f, n, r, o, a, i, s, c, u))) {
                case void 0:
                case !1:
                case !0:
                case null:
          ...
          function c(e) {
            return (
              void 0 !== (e = e.prefix) &&
                ((I = null), e ? ('function' != typeof e ? (O = 1) : ((O = 2), (I = e))) : (O = 0)),
              c
            );
          }
          function l(e, n) {
            ...
            if ((33 > r.charCodeAt(0) && (r = r.trim()), (r = [r]), 0 < N)) {
              var o = s(-1, n, r, r, x, R, 0, 0, 0, 0);
              void 0 !== o && 'string' == typeof o && (n = o);
            }
            var a = t(T, r, n, 0, 0);
            return (
              0 < N && void 0 !== (o = s(-2, a, r, r, x, R, a.length, 0, 0, 0)) && (a = o),
              (A = 0),
              (R = x = 1),
              a
            );
      ...
      var R = (function () {
        ...
        I = 'style[' + S + '][data-styled-version="5.3.0"]',
            ...
            if (i) {
              ...
              if (s) {
                var c = 0 | parseInt(s[1], 10),
                  l = s[2];
                0 !== c && (N(l, c), L(e, l, s[3]), e.getTag().insertRules(c, r)), (r.length = 0);
              } else r.push(i);
            }
          }
        },
        ...
        q = E,
        B = { isServer: !E, useCSSOMInjection: !k },
        z = (function () {
          function e(e, t, n) {
            void 0 === e && (e = y),
              void 0 === t && (t = {}),
          ...
          return (
            (t.reconstructWithOptions = function (t, n) {
              return (
                void 0 === n && (n = !0),
                new e(f({}, this.options, {}, t), this.gs, (n && this.names) || void 0)
              );
            }),
              ...
              if (
                ...
                if (this.staticRulesId && t.hasNameForId(r, this.staticRulesId))
                  ...
                  var a = ve(this.rules, e, t, n).join(''),
                    i = Q(V(this.baseHash, a.length) >>> 0);
                ...
                for (
                  var c = this.rules.length, l = V(this.baseHash, n.hash), u = '', p = 0;
                  p < c;
                  p++
                ) {
                  var d = this.rules[p];
      ...
      function ge(e) {
        return de.test(e) ? e.replace(fe, me).replace(he, '-ms-') : e;
      }
      var ye = function (e) {
        return null == e || !1 === e || '' === e;
      };
      ...
      function Ae(e) {
        ...
        for (var o = 0, a = n; o < a.length; o++) {
          var i = a[o];
          if (Pe(i)) for (var s in i) Re(s) && xe(e, i[s], s);
        }
        return e;
      }
      ...
      function je(e) {
        ...
        return e.children ? o.createElement(Oe.Provider, { value: n }, e.children) : null;
      }
      var Ne = {};
      function Ie(e, t, n) {
        var r = w(e),
        ...
        r &&
          ...
          (C = t.shouldForwardProp
            ...
            : e.shouldForwardProp);
        var E,
          k = new Z(n, m, r ? e.componentStyle : void 0),
          _ = k.isStatic && 0 === s.length,
          P = function (e, t) {
            return (function (e, t, n, r) {
              var a = e.attrs,
                ...
                })(we(t, (0, o.useContext)(Oe), s) || y, t, a),
                m = h[0],
                g = h[1],
                b = (function (e, t, n) {
                  var r = ce(),
              ...
              for (var _ in E)
                '$' !== _[0] &&
                  ...
                  ('forwardedAs' === _
                    ? (k.as = E[_])
                    : (l ? l(_, u, S) : !C || u(_)) && (k[_] = E[_]));
              return (
                t.style && g.style !== t.style && (k.style = f({}, t.style, {}, g.style)),
                (k.className = Array.prototype
                  .concat(c, p, b !== p ? b : null, t.className, g.className)
                  .filter(Boolean)
                  .join(' ')),
                (k.ref = w),
        ...
        return (
          (P.displayName = h),
          ((E = o.forwardRef(P)).attrs = S),
          (E.componentStyle = k),
          (E.displayName = h),
          (E.shouldForwardProp = C),
          ...
          (E.withComponent = function (e) {
            var r = t.componentId,
              ...
              a = r && r + '-' + (_e(e) ? e : Ee(b(e)));
            return Ie(e, f({}, o, { attrs: S, componentId: a }), n);
          }),
      ...
      var De = function (e) {
        return (function e(t, n, o) {
          if ((void 0 === o && (o = y), !(0, r.isValidElementType)(n))) return P(1, String(n));
          var a = function () {
          ...
          return (
            ...
            (a.attrs = function (r) {
              return e(
                t,
                n,
                f({}, o, { attrs: Array.prototype.concat(o.attrs, r).filter(Boolean) }),
              );
            }),
            a
          );
      ...
      function $e(e) {
        ...
        function l(e, t, n, r, o) {
          if (s.isStatic) s.renderStyles(e, _, n, o);
          else {
            var a = f({}, t, { theme: we(t, r, c.defaultProps) });
      ...
      var He = (function () {
          ...
          return (
            (t.collectStyles = function (e) {
              return this.sealed ? P(2) : o.createElement(ue, { sheet: this.instance }, e);
            }),
        ...
        Fe = function () {
          return (0, o.useContext)(Oe);
        },
        Ue = { StyleSheet: z, masterSheet: ie },
        qe = De;
    },
    2475: function (e) {
    ...
    6462: function (e, t, n) {
      ...
      function E(e) {
        ...
        o.useEffect(() => {
          Promise.resolve().then(() => {
            const o = x(t, i);
            h(A(o, e), { replace: n, state: r });
          });
        }, []);
        const s = x(t, i);
        return a || C(A(s, e)), null;
      }
      const k = e => {
        const t = b(),
          { baseuri: n } = v();
        return o.createElement(E, s({}, t, { baseuri: n }, e));
      };
      k.propTypes = { from: a.string, to: a.string.isRequired };
      const _ = (e, t) => e.substr(0, t.length) === t,
        P = (e, t) => {
          let n, r;
          const [o] = t.split('?'),
            a = L(o),
        ...
        F = e => t => {
          ...
          if (
            ...
            i(
              !(t.type === k && !O(t.props.from, t.props.to)),
      ...
      const G = () => {},
        J = z((e, t) => {
          ...
          const { baseuri: a } = v(),
            { location: i } = b(),
            { to: l, state: u, replace: p, getProps: d = G } = r,
            f = c(r, q),
            m = x(l, a),
            g = encodeURI(m),
            y = i.pathname === g,
          ...
          return o.createElement(
            ...
            s(
              ...
              f,
              d({ isCurrent: y, isPartiallyCurrent: w, href: m, location: i }),
              {
                href: m,
                onClick: e => {
                  if (
      ...
      const X = (function (e) {
          var t, n;
          function r(t) {
            return o.createElement(Y, null, o.createElement(e, s({ key: 'WrappedComponent' }, t)));
          }
          return (
          ...
          o.useEffect(
            ...
            o.useEffect(() => {
              ...
              a !== d.current && ((d.current = a), (e = !0)),
                ...
                (h.current = e || (t && i.pathname === a)),
                h.current && m();
            }, [a, i]);
          const m = o.useCallback(() => {
            var e;
            p.current ? (p.current = !1) : ((e = u.current), h.current && e && e.focus());
          }, []);
          return o.createElement(
            r,
            s({ style: s({ outline: 'none' }, n), tabIndex: '-1', ref: u }, l),
            t,
          );
        },
      ...
      function ce(e) {
        ...
        if (d) {
          const {
            ...
            f = s({}, e, { uri: r, location: t }),
            h = o.cloneElement(
              u,
              f,
              u.props.children
                ? o.createElement(se, { location: t, primary: n }, u.props.children)
                : void 0,
            ),
            m = n ? re : i,
            y = n ? s({ uri: r, location: t, component: i }, l) : l;
          return o.createElement(
            g.Provider,
    ...
    7078: function (e, t, n) {
                    ...
                    onClick: e => {
                      if (
                        ...
                        'boolean' != typeof p && n && (t = !0),
                          window.___navigate(h, { state: l, replace: t });
                      }
                      return !0;
                    },
                  },
      ...
      const C = o.forwardRef((e, t) => o.createElement(w, s({ innerRef: t }, e))),
        E = (e, t) => {
    ...
    5535: function (e, t, n) {
      ...
      function g(e) {
        const { id: t, src: n, strategy: r = l.postHydrate, onLoad: o, onError: i } = e || {},
          s = t || n,
          c = ['load', 'error'],
          u = { load: o, error: i };
        if (s) {
        ...
        for (const [a, l] of Object.entries(b)) S.setAttribute(a, l);
        ...
        return (
          ...
          { script: S, loadCallback: C.loadCallback, errorCallback: C.errorCallback }
        );
      }
      function y(e) {
...
//# sourceMappingURL=app-4bb4bf1f4a2807ab105e.js.map
